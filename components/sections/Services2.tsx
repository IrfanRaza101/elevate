				...
				<div className="container position-relative z-2">
					<div className="text-center">
						<div className="d-flex align-items-center justify-content-center bg-primary-soft border border-2 border-white d-inline-flex rounded-pill px-4 py-2" data-aos="zoom-in" data-aos-delay={100}>
							...
							<span className="tag-spacing fs-7 fw-bold text-linear-2 ms-2 text-uppercase">What we deliver</span>
						</div>
						<h3 className="ds-3 my-3 fw-regular">
							Built for presentations
							<span className=" fw-bold">Services <br className="d-none d-lg-inline" />
								that scale</span>
							with your team
						</h3>
					</div>
						...
						<div className="col-lg-4 col-md-6">
							<div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
								<div className="card-service bg-white p-6 border rounded-4 text-center">
									...
									<h5 className="my-3">Pitch Deck Design</h5>
									<p className="mb-6">Investor and fundraising decks that sharpen the story, highlight traction, and drive next steps.</p>
						...
						<div className="col-lg-4 col-md-6">
							<div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
								<div className="card-service bg-white p-6 border rounded-4 text-center">
									...
									<h5 className="my-3">Sales & Marketing Decks</h5>
									<p className="mb-6">Persuasive sales and marketing presentations that convert prospects into confident buyers.</p>
									<Link href="#" className="text-primary fs-7 fw-bold">
										Learn More
										<svg className=" ms-2 " xmlns="http://www.w3.org/2000/svg" width={19} height={18} viewBox="0 0 19 18" fill="none">
											<g clipPath="url(#clip0_399_9647)">
						...
						<div className="col-lg-4 col-md-6">
							<div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
								<div className="card-service bg-white p-6 border rounded-4 text-center">
									...
									<h5 className="my-3">Company Profiles</h5>
									<p className="mb-6">Brand and company profile decks aligned to your story, positioning, and visual identity.</p>
									<Link href="#" className="text-primary fs-7 fw-bold">
										Learn More
										<svg className=" ms-2 " xmlns="http://www.w3.org/2000/svg" width={19} height={18} viewBox="0 0 19 18" fill="none">
											<g clipPath="url(#clip0_399_9647)">
						...
						<div className="col-lg-4 col-md-6">
							<div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
								<div className="card-service bg-white p-6 border rounded-4 text-center">
									...
									<h5 className="my-3">Data Visualization</h5>
									<p className="mb-6">Clear charts and diagrams that make complex data instantly understandable.</p>
									<Link href="#" className="text-primary fs-7 fw-bold">
										Learn More
										<svg className=" ms-2 " xmlns="http://www.w3.org/2000/svg" width={19} height={18} viewBox="0 0 19 18" fill="none">
											<g clipPath="url(#clip0_399_9647)">
						...
						<div className="col-lg-4 col-md-6">
							<div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
								<div className="card-service bg-white p-6 border rounded-4 text-center">
									...
									<h5 className="my-3">Template Systems</h5>
									<p className="mb-6">Scalable slide templates and libraries so every team stays on-brand.</p>
									<Link href="#" className="text-primary fs-7 fw-bold">
										Learn More
										<svg className=" ms-2 " xmlns="http://www.w3.org/2000/svg" width={19} height={18} viewBox="0 0 19 18" fill="none">
											<g clipPath="url(#clip0_399_9647)">
						...
						<div className="col-lg-4 col-md-6">
							<div className="p-2 rounded-4 shadow-1 bg-white position-relative z-1 hover-up mb-4">
								<div className="card-service bg-white p-6 border rounded-4 text-center">
									...
									<h5 className="my-3">Executive Presentations</h5>
									<p className="mb-6">Board and leadership-ready decks with concise messaging and polish.</p>
									<Link href="#" className="text-primary fs-7 fw-bold">
										Learn More
										<svg className=" ms-2 " xmlns="http://www.w3.org/2000/svg" width={19} height={18} viewBox="0 0 19 18" fill="none">
											<g clipPath="url(#clip0_399_9647)">
