				...
				<div className="container">
					<div className="row align-items-end">
						<div className="col-12 col-md-4 me-auto">
							...
							<h3 className="ds-3 mt-3 mb-3">Presentation Insights</h3>
							<span className="fs-5 fw-medium">Tactics for story, design, and clarity</span>
						</div>
							...
							<div className="swiper-wrapper">
								...
								<SwiperSlide className="swiper-slide">
									<div className="card border-0 position-relative rounded-3 d-inline-flex card-hover shadow-2">
										...
										<Link href="#" className="position-absolute z-1 m-3 bg-primary-soft border border-2 border-white d-inline-flex rounded-pill px-3 py-1">
											<span className="tag-spacing fs-7 fw-bold text-linear-2 ms-2 text-uppercase">Pitching</span>
										</Link>
										<div className="card-body bg-white border border-top-0 rounded-bottom-3 p-6">
											<h6 className="mb-3">A pitch deck outline that drives yes</h6>
											<p>The essentials you need to move investors or executives to action.</p>
								...
								<SwiperSlide className="swiper-slide">
									<div className="card border-0 position-relative rounded-3 d-inline-flex card-hover shadow-2">
										...
										<Link href="#" className="position-absolute z-1 m-3 bg-primary-soft border border-2 border-white d-inline-flex rounded-pill px-3 py-1">
											<span className="tag-spacing fs-7 fw-bold text-linear-2 ms-2 text-uppercase">Design</span>
										</Link>
										<div className="card-body bg-white border border-top-0 rounded-bottom-3 p-6">
											<h6 className="mb-3">Design rules for readable data slides</h6>
											<p>Small layout choices that make charts and tables instantly clear.</p>
											<div className="d-flex align-items-center justify-content-between mt-5 pt-5 border-top ">
												<div className="d-flex align-items-center">
													<div className="icon-shape rounded-circle border border-2 border-white">
								...
								<SwiperSlide className="swiper-slide">
									<div className="card border-0 position-relative rounded-3 d-inline-flex card-hover shadow-2">
										...
										<Link href="#" className="position-absolute z-1 m-3 bg-primary-soft border border-2 border-white d-inline-flex rounded-pill px-3 py-1">
											<span className="tag-spacing fs-7 fw-bold text-linear-2 ms-2 text-uppercase">Storytelling</span>
										</Link>
										<div className="card-body bg-white border border-top-0 rounded-bottom-3 p-6">
											<h6 className="mb-3">Executive updates that fit in 10 slides</h6>
											<p>What to keep, what to cut, and how to land the recommendation.</p>
											<div className="d-flex align-items-center justify-content-between mt-5 pt-5 border-top ">
												<div className="d-flex align-items-center">
													<div className="icon-shape rounded-circle border border-2 border-white">
