				...
				<div className="container position-relative z-2">
					<div className="row align-items-end">
						<div className="col-lg-7 me-auto">
							...
							<span className="fs-5 fw-medium text-900">Short reads on story, design, and outcomes</span>
						</div>
						<div className="col-lg-auto">
							<Link href="#" className="fw-bold text-primary btn bg-white hover-up shadow-2 mt-lg-0 mt-5 ms-lg-auto">See all insights
						...
						<div className="col-lg-7">
							<div className="card-team position-relative d-flex flex-lg-row flex-column align-items-center rounded-3 border  card-hover shadow-2 mb-lg-0 mb-8">
								...
								<div className="bg-white align-self-stretch rounded rounded-start-lg-0 p-5">
									...
									<h6 className="mb-3">A pitch deck outline that investors understand</h6>
									<p>How to frame problem, solution, and traction so decisions move faster.</p>
							...
							<div>
								<Link href="#" className="d-flex flex-column flex-md-row align-items-center hover-up">
									...
									<div className="content ms-5 mt-4 mt-md-0">
										<h6 className="mb-2">Brand systems for decks that scale</h6>
										<p className="mb-0">Keep every team on-brand with clear structure and reusable slide styles.</p>
									</div>
								</Link>
								<Link href="#" className="d-flex flex-column flex-md-row align-items-center mt-7 hover-up">
									...
									<div className="content ms-5 mt-4 mt-md-0">
										<h6 className="mb-2">How to make data slides feel obvious</h6>
										<p className="mb-0">Design patterns that help audiences grasp the takeaway instantly.</p>
									</div>
								</Link>
							</div>
						</div>
