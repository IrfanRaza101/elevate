...
export default function BeforeAfter() {
	...
	return (
		<>
			<section className="section-before-after section-padding bg-neutral-0">
				<div className="container">
					<div className="row">
						<div className="col-lg-8 mx-auto text-center mb-8">
							<div className="d-flex align-items-center justify-content-center bg-primary-soft border border-2 border-white d-inline-flex rounded-pill px-4 py-2" data-aos="zoom-in" data-aos-delay={100}>
								<img src="/assets/imgs/features-1/dots.png" alt="infinia" />
								<span className="tag-spacing fs-7 fw-bold text-linear-2 ms-2 text-uppercase">TRANSFORMATION</span>
							</div>
							<h3 className="ds-3 my-3" data-aos="fade-up" data-aos-delay={200}>
								See The Difference We Make
							</h3>
							<p className="fs-5 mb-0" data-aos="fade-up" data-aos-delay={300}>
								Drag the slider to see how we transform ordinary presentations into <br />
					...
					<div className="row justify-content-center">
						<div className="col-lg-10">
							<div 
								className="before-after-container position-relative overflow-hidden rounded-4 shadow-lg"
								ref={containerRef}
								data-aos="fade-up" 
								data-aos-delay={400}
							...
							>
								...
								<div className="before-image position-absolute w-100 h-100">
									...
									<div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
										<div className="bg-black bg-opacity-75 text-white px-4 py-2 rounded-pill">
											<h6 className="mb-0 fw-bold text-white">BEFORE</h6>
										</div>
									</div>
								</div>
								...
								>
									...
									/>
									<div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
										<div className="bg-primary text-white px-4 py-2 rounded-pill">
											<h6 className="mb-0 fw-bold text-white">AFTER</h6>
										</div>
									</div>
								</div>
								...
								<div className="position-absolute bottom-0 start-0 p-4">
									<div className="bg-dark bg-opacity-75 text-white px-3 py-2 rounded">
										<small className="fw-bold">Drag to compare</small>
									</div>
								</div>
							</div>
						</div>
					...
					<div className="row mt-8">
						<div className="col-lg-4 mb-4" data-aos="fade-up" data-aos-delay={500}>
							<div className="text-center">
								...
								<h6 className="fw-bold mb-2">Professional Design</h6>
								<p className="text-500 mb-0">Transform basic slides into visually stunning presentations</p>
							</div>
						</div>
						<div className="col-lg-4 mb-4" data-aos="fade-up" data-aos-delay={600}>
							<div className="text-center">
								...
								<p className="text-500 mb-0">Maintain your brand identity across all presentation materials</p>
							</div>
						</div>
						<div className="col-lg-4 mb-4" data-aos="fade-up" data-aos-delay={700}>
							<div className="text-center">
								<div className="icon-shape icon-lg bg-primary-soft rounded-circle mx-auto mb-3">
									<svg className="text-primary" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
								...
								<h6 className="fw-bold mb-2">Quick Turnaround</h6>
								<p className="text-500 mb-0">Get your polished presentations delivered in record time</p>
							</div>
						</div>
					</div>
				</div>
