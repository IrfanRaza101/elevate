...
export default function Hero1() {
    return (
        <>
            {/* 1440px+ ke liye specific responsive fixes */}
            <style jsx global>{`
                @media (min-width: 1441px) {
                    /* Container ko lock hone se rokne ke liye */
                    #home .container {
                        max-width: 90% !important;
                        width: 100% !important;
                    }
                    /* Heading aur text ko bari screen ke mutabiq scale karne ke liye */
                    #home .ds-4 {
                    ...
                    /* Image container ko bara karne ke liye */
                    .hero-img-wrapper {
            ...
            <section id="home" className="position-relative overflow-hidden pb-10">
                <div className="m-5 p-5">
                    {/* Aapka margin aur height logic same rakha hai */}
