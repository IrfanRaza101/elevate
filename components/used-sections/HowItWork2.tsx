...
export default function HowItWork2() {
	return (
		<>
			<section id="how-it-works" className="howitwork-2 section-padding position-relative fix">
					...
					<div className="row position-relative justify-content-center">
						<div className="col-lg-4 text-center px-md-10">
							<div className="card-service-4 text-center mt-2">
								...
								<h5 className="my-3">Share Your Vision</h5>
								<p className="mb-6">Tell us about your presentation needs, audience, and goals to get started.</p>
							</div>
						</div>
						<div className="col-lg-4 text-center px-md-10">
							<div className="card-service-4 text-center mt-2">
								...
								<h5 className="my-3">Design & Create</h5>
								<p className="mb-6">Our expert designers craft your presentation with custom layouts, graphics, and animations.</p>
							</div>
						</div>
						<div className="col-lg-4 text-center px-md-10">
							<div className="card-service-4 text-center mt-2">
								...
								<h5 className="my-3">Deliver & Support</h5>
								<p className="mb-6">Receive your stunning presentation with revisions and ongoing support included.</p>
							</div>
						</div>
					</div>
