					...
					<div className="row align-items-center">
						<div className="col-lg-6 col-md-12 mb-5 mb-lg-0">
							<div className="text-start pe-lg-2">
								...
								<h3 className="ds-3 ds-md-2 mt-3 mb-3 fw-regular">Our Design <span className="fw-bold">Team</span></h3>
								...
								<div className="d-flex flex-column flex-md-row align-items-start align-items-md-center mt-5">
									...
									<Link 
										...
										target="_blank"
										className="btn btn-gradient d-flex align-items-center rounded-pill px-4 py-3 text-decoration-none hover-up"
