...
export default function Team2() {
	return (
		<>
			<section id="team" className="section-team-2 section-padding">
						...
						<div className="col-lg-6">
							<div className="text-start mb-lg-0 mb-lg-5 mb-10">
								...
								<div className="d-flex align-items-center mt-8">
									<h6 className="text-500 mb-0 me-3">Ready to start your project?</h6>
									<Link 
										href="https://wa.me/923172651450" 
										target="_blank"
										className="btn btn-gradient d-flex align-items-center px-4 py-2 rounded-pill text-decoration-none hover-up"
										style={{color: 'white'}}
									>
