					...
					<div className="container">
						<div className="row align-items-center">
							<div className="col-lg-5">
								...
								<button className="btn btn-gradient text-white mt-4 rounded-pill px-4 py-3" style={{ backgroundColor: '#1E90FF', borderColor: '#1E90FF', fontSize: '0.9rem' }}>Get Started Now</button>
