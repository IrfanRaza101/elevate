...
export default function BackToTop({ 
	target, 
	whatsappNumber = "+923172651450", // Default number - replace with actual
	...
	return (
		<>
			<div className={`floating-buttons ${hasScrolled ? 'show' : ''}`}>
				{/* WhatsApp Button */}
				<div 
					className="btn btn-gradient p-3" 
				...
				{/* Back to Top Button */}
				<div className="btn btn-gradient p-3" onClick={handleBackToTop} style={{backgroundColor: '#007bff', borderRadius: '50%'}}>
